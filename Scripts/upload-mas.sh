...
# that must ask for the real thing. Automatic signing archives with the
# Apple Development identity — naming Apple Distribution here as well is a
# conflict xcodebuild rejects; the export step below re-signs the archive
