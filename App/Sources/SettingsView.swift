        ...
        Form {
            ...
            Section("Performance") {
                ...
                caption(MetalEngine.shared == nil
                        ? "No usable GPU found — fusing runs on the CPU."
                        : "Fuse on the GPU (identical results, usually faster). Turn off to reduce memory pressure on low-RAM machines, free the GPU for other work, or rule out a driver issue.")
